    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            ...
            <!--Validacion de errores-->
                ...
                <div class="card">
                    <form action="{{ route('edit', $usuario->id)}}" method="POST" enctype="multipart/form-data">//enviamos la informacion
                        @csrf @method('PATCH')
                        <div class="card-header  text-center  p-3 mb-2 bg-info text-white">MODIFICAR USUARIO</div>
                        <td>
                            <img src="{{ asset('storage').'/'.$usuario->foto}}" alt="" height="90">
                        </td>
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                ...
                                <input type="file" name="foto" class="form-control col-md-9" value="{{ $usuario->foto }}">
                            </div>
